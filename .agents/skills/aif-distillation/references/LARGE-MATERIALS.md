...
```bash
python3 .agents/skills/aif-distillation/scripts/material-prep.py <source...>
```
...
```bash
python3 .agents/skills/aif-distillation/scripts/material-prep.py --cleanup <temp-dir>
```
